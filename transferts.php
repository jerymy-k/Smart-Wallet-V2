    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                ...
                <?php if ($message): ?>
                    <div
                        class="mb-6 p-4 rounded-lg <?php echo $message_type === 'success' ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200' : 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200'; ?>">
                ...
                <?php if (!$has_principal_card): ?>
                    ...
                    <div
                        class="mb-8 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-6">
                        <div class="flex items-start gap-3">
                            <span class="material-symbols-outlined text-yellow-600 dark:text-yellow-400">info</span>
                            <div>
                                <p class="font-semibold text-yellow-800 dark:text-yellow-400 text-sm mb-1">No principal card
                                    found</p>
                                <p class="text-sm text-yellow-700 dark:text-yellow-300">
                                    You must add a card and set it as principal before you can send money.
                                </p>
                                <a href="cards.php"
                                    class="inline-flex mt-4 items-center gap-2 px-4 py-2 rounded-lg bg-primary text-white font-semibold">
                                    <span class="material-symbols-outlined">credit_card</span>
                                    Go to Cards
                                </a>
                            </div>
                ...
                <?php if ($has_principal_card): ?>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div
                            ...
                            <form method="POST" action="process_transfer.php" class="space-y-5">
                                <div class="space-y-2">
                                    ...
                                    <input type="text" name="recipient" placeholder="example@email.com or user ID" required
                                        class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400">
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="number" name="amount" step="0.01" min="0.01"
                                            max="<?php echo $current_balance; ?>" placeholder="0.00" required
                                            class="w-full pl-16 pr-4 py-3 bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400">
                                    </div>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="note" rows="3" placeholder="Add a note..."
                                        class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-border-light dark:border-border-dark rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400 resize-none"></textarea>
                                </div>

                                <button type="submit"
                                    class="w-full bg-primary hover:bg-green-600 text-white font-semibold py-3 rounded-lg transition-colors shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
                        ...
                        <div class="space-y-6">
                            <!-- Principal Card -->
                            <div
                                class="bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-900 rounded-xl p-6 shadow-lg text-white">
                                ...
                                <p class="text-3xl font-bold"><?php echo number_format($current_balance, 2); ?> <span
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div
                                    class="bg-card-light dark:bg-card-dark rounded-xl p-5 border border-border-light dark:border-border-dark">
                            ...
                            <div
                                ...
                                <div class="flex gap-3">
                                    <span class="material-symbols-outlined text-yellow-600 dark:text-yellow-400">info</span>
                                    <div>
                                        <p class="font-semibold text-yellow-800 dark:text-yellow-400 text-sm mb-1">Important
                                        </p>
                                        <p class="text-sm text-yellow-700 dark:text-yellow-300">Transfers are instant. Make
                                            sure you enter the correct recipient details.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                        <!-- Chart -->
                        <div
                            class="xl:col-span-2 bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-xl shadow-subtle p-6">
                            <div class="mb-6">
                        ...
                        <!-- Recent Transfers -->
                        <div
                            class="bg-card-light dark:bg-card-dark border border-border-light dark:border-border-dark rounded-xl shadow-subtle p-6">
                            ...
                            <div class="space-y-4 max-h-[400px] overflow-y-auto">
                                ...
                                if ($transfers_result->num_rows > 0):
                                    while ($transfer = $transfers_result->fetch_assoc()):
                                        ...
                                        ?>
                                        <div
                                            class="flex items-center justify-between p-3 <?php echo $is_sent ? 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800' : 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800'; ?> rounded-lg">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="<?php echo $is_sent ? 'bg-red-500/20' : 'bg-green-500/20'; ?> rounded-full p-2">
                                                    <span
                                                        class="material-symbols-outlined <?php echo $is_sent ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'; ?> text-sm"><?php echo $is_sent ? 'arrow_upward' : 'arrow_downward'; ?></span>
                                                </div>
                                                <div>
                                                    <p class="text-sm font-semibold text-gray-900 dark:text-white">
                                                        <?php echo $is_sent ? 'Sent to' : 'Received from'; ?>
                                                        <?php echo htmlspecialchars($other_party); ?>
                                                    </p>
                                    ...
                                    <div class="text-center py-8">
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">No transfers yet
                                        </h3>
                                        <p class="text-gray-500 dark:text-gray-400 text-sm">Your transfer history will appear
                                            here</p>
                                    </div>
                                <?php endif; ?>
                            </div>
