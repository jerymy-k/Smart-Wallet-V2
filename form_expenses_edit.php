...
$id = $_GET['id'];
$result_edit = $conn->query("SELECT * FROM expenses WHERE id=$id");
...
<head>
    ...
    <title>Edit Expense - FinanceApp</title>
...
<body class="relative flex w-screen font-display bg-background-light dark:bg-background-dark">
    <aside id="sidebar"
        ...
        <div class="flex flex-col flex-grow p-4">
            ...
            <nav class="flex flex-col gap-2 flex-grow">
                ...
                <a class="allincomes flex items-center gap-3 px-4 py-2.5 rounded-lg bg-primary/10 text-primary font-semibold hover:bg-primary/20 transition-colors"
                    href="incomes.php">
    ...
    <main class="relative h-screen flex-1 overflow-y-auto">
        <section class="p-8 max-w-2xl mx-auto">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-2">Edit Expense</h1>
                <p class="text-gray-500 dark:text-gray-400">Update the expense details below</p>
            </div>

            <div
                class="bg-card-light dark:bg-card-dark rounded-xl shadow-subtle p-6 border border-border-light dark:border-border-dark">
                <form action='expenses_edit.php' method="POST" class="space-y-6">
                    <input type="hidden" name="id" value="<?php echo $row_edit['id']; ?>">

                    <div class="space-y-2">
                        <label for="montant_expenses" class="block text-sm font-semibold text-gray-900 dark:text-white">
                            Montant
                        </label>
                        <div class="relative">
                            <span
                            ...
                            <input type="text" name="montant_expenses" id="montant_expenses"
                    ...
                    <div class="space-y-2">
                        <label for="expenses_desc" class="block text-sm font-semibold text-gray-900 dark:text-white">
                            Description
                        </label>
                        <div class="relative">
                            <span
                            ...
                            <textarea name="expenses_desc" id="expenses_desc" rows="4"
